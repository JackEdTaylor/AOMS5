...
For now ([*ominous foreshadowing*](04-random_correlations)), we will simulate the random effects independently. This means that we just draw $P_{1p}$ from yet another independent normal distribution:
