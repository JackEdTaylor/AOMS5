...
set.seed(1728048435)  # from sample(.Machine$integer.max, 1)
```
...
As before, the <span style="color:red;">**red line**</span> shows the fixed effect, while the **black lines** show variability between (a) items and (b) participants. The <span style="color:blue;">**blue line**</span> in the last panel shows the relationship between $P_{0p}$ and $P_{1p}$.
